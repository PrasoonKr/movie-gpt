...
const VideoTitle = ({ title, overview }) => {
  return (
    <div className="w-screen aspect-video pt-[20%] px-20 absolute text-white bg-gradient-to-r from-black">
      ...
      <div className="flex">
        <button className="bg-white text-black mr-3 py-3 px-9 text-xl font-bold flex rounded-lg hover:opacity-80 ">
          <FaPlay className=" text-2xl mr-2 pt-1" />
          Play
        </button>
        <button className=" flex text-white py-3 px-6 text-xl  font-bold rounded-lg bg-slate-800 hover:opacity-80 ">
